...
% Vernacular commands
morekeywords=[1]{
Section, Module, End, Require, Import, Export, Scheme, % Scheme added by ben
...
Search, Show, Print, Printing, All, Graph, Projections, inside, outside
 , Check, Obligation, Eval % added by ben
},
...
morekeywords=[4]{
         pose, set, move, case, elim, apply, clear,
            hnf, intro, intros, generalize, pattern, after, %rename,
