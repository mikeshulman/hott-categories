...
\begin{rmk}
  ...
  It is also possible to give a direct construction of $\widehat A$ using higher inductive types, which leaves its universe level unchanged.
\end{rmk}
...
Ideally, we would like a full theory of $(\infty,1)$-categories, but there are obstacles to formalizing such infinite towers of structures in currently available type theories.
